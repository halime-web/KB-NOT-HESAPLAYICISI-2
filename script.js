document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", function(e){
        ...
        if (isNaN(vize) || vize < 0 || vize > 100) { alert("Vize 0-100 arasında olmalı!"); return; }

        if (!devamsiz && isNaN(finalNot) && isNaN(but)) { alert("Final veya Bütünleme notu gerekli!"); return; }
